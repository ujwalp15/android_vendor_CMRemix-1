...
ALARM_PATH := vendor/cmremix/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cmremix/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cmremix/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/cmremix/prebuilt/common/media/audio/ui
